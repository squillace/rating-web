<template>
  <section>
    ...
    <div class="row at-row flex-center flex-middle">
      ...
      <div class="col-lg-6">
        <at-button @click="link('Rating')" icon="icon-star" class="mid-btn" type="primary"  hollow>Start Rating Immediately</at-button>
      </div>
      <div class="col-lg-6">
        <at-button @click="link('Leaderboard')" icon="icon-bar-chart-2" class="mid-btn" type="success" hollow>View Leaderboard</at-button>
      </div>
      <div class="col-lg-6">
        <a href="https://github.com/squillace/rating-web" target="_blank"><at-button icon="icon-github" class="mid-btn" type="info" hollow>Steal This Code</at-button></a>
      </div>
      <div class="col-lg-3">
      </div>
    </div>
